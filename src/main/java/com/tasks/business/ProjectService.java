...
public class ProjectService {
    ...
    @Transactional
    public void removeById(Long id) throws InstanceNotFoundException {              //modificaciones para eliminar con propietario
        ...
        if (optTask.get().getAdmin().getUsername().equals(authName)){
